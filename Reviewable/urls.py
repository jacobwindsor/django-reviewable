...
urlpatterns = [
    ...
    url(r'(?P<content_type>[\w-]+)/(?P<pk>[0-9]+)/create$', views.ReviewCreate.as_view(), name='create-review'),
    url(r'(?P<content_type>[\w-]+)/(?P<pk>[0-9]+)/list$', views.ReviewList.as_view(), name='list-review'),
]
